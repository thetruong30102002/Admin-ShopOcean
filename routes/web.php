...
Route::get('user/edit/ajax/location/getLocation',[LocationController::class,'getLocation'])->name('user.ajax.location.getLocation')->middleware('authen');
...
Route::get('user/edit/{id}',[UserController::class,'edit'])->name('user.edit')->middleware('authen');
Route::post('user/update/{id}',[UserController::class,'update'])->name('user.update')->middleware('authen');
Route::get('user/delete/{id}',[UserController::class,'delete'])->name('user.delete')->middleware('authen');

Route::delete('user/destroy/{id}',[UserController::class,'destroy'])->name('user.destroy')->middleware('authen');